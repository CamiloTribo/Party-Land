...
export function NewsDrawer({ isOpen, onClose, onOpenFCSkin, onOpenAirdrop, onOpenOffer }: NewsDrawerProps) {
    const news: NewsCard[] = [
        ...
        },
        {
            ...
            title: 'Airdrop Week 1 — Pool Growing',
            body: 'Join with 1500 tokens + $0.023 USDC. Fewer participants = bigger payout per person. Pool closes March 9.',
            highlight: 'Pool: $10+ USDC · Closes Mar 9',
            date: 'Mar 2, 2026',
            cta: 'Enter Airdrop',
