...
const TOKEN_THEMES = [
  ...
  { id: 'royal-purple', name: 'Royal Purple', cost: 750, bg: 'bg-gradient-to-br from-[#581c87] to-[#6b21a8]', description: 'Majestic & elegant' },
  { id: 'fire-red', name: 'Fire Red', cost: 1500, bg: 'bg-gradient-to-br from-[#7f1d1d] to-[#991b1b]', description: 'Burning passion' },
  { id: 'cyber-neon', name: 'Cyber Neon', cost: 2200, bg: 'bg-gradient-to-br from-[#164e63] to-[#6b21a8]', description: 'Futuristic glow' },
  { id: 'golden-luxury', name: 'Golden Luxury', cost: 3000, bg: 'bg-gradient-to-br from-[#713f12] to-[#a16207]', description: 'Pure elegance' },
  { id: 'midnight-dark', name: 'Midnight Dark', cost: 4000, bg: 'bg-gradient-to-br from-[#334155] to-[#0f172a]', description: 'Mystery night' },
  { id: 'candy-pop', name: 'Candy Pop', cost: 5000, bg: 'bg-gradient-to-br from-[#ec4899] to-[#3b82f6]', description: 'Sweet & colorful' },
  { id: 'toxic-slime', name: 'Toxic Slime', cost: 6000, bg: 'bg-gradient-to-br from-[#65a30d] to-[#15803d]', description: 'Radioactive vibes' },
  { id: 'arctic-ice', name: 'Arctic Ice', cost: 7500, bg: 'bg-gradient-to-br from-[#67e8f9] to-[#0ea5e9]', description: 'Frozen wonderland' },
  { id: 'lava-flow', name: 'Lava Flow', cost: 11000, bg: 'bg-gradient-to-br from-[#ea580c] to-[#18181b]', description: 'Volcanic power' },
  { id: 'galaxy-space', name: 'Galaxy Space', cost: 15000, bg: 'bg-gradient-to-br from-[#312e81] to-[#ec4899]', description: 'Among the stars' },
  { id: 'rainbow-dream', name: 'Rainbow Dream', cost: 22000, bg: 'bg-gradient-to-br from-[#ef4444] to-[#8b5cf6]', description: 'All colors united' },
  { id: 'diamond-shine', name: 'Diamond Shine', cost: 40000, bg: 'bg-gradient-to-br from-[#e5e7eb] to-[#a78bfa]', description: 'Ultimate brilliance' },
];
...
export default function ShopThemesScreen({ onBack, soundEnabled, onToggleSound }: ShopThemesScreenProps) {
  ...
  const handlePurchaseSuccess = (txHash?: string) => {
    ...
    if (selectedItem) {
      buyTheme(selectedItem.id, selectedItem.cost, txHash).then(() => {
        selectTheme(selectedItem.id);
        refetchUSDC();
        setModalType('success');
      });
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-purple-900 via-purple-800 to-purple-900 overflow-y-auto">
      ...
      {/* Grid de Items */}
      <div id="tutorial-shop-themes-grid" className="flex-1 overflow-y-auto px-4 pb-20">
        <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto pb-10">
