...
import { PAYMENT_WALLET_ADDRESS, PAYMENT_CHAIN_ID, BUILDER_CODE } from '~/lib/constants';
...
export function PaymentModal({ isOpen, onClose, onSuccess, item }: PaymentModalProps) {
  ...
  const handlePurchase = async () => {
    try {
      ...
      const txData = attachBuilderCode();
      console.log('📝 [PaymentModal] ETH Transaction Attribution:', {
        code: BUILDER_CODE,
        fullData: txData
      });
