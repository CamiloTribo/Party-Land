...
export default function PinkPantherPlayer({
  ...
  const skins: Record<string, { body: string; dark: string; accent: string }> = {
    ...
    // Special Edition
    farcaster: { body: '#8465CB', dark: '#5B47A8', accent: '#E8E0F7' },
  }
      ...
      <svg width="40" height="50" viewBox="0 0 40 50" className={isMoving ? 'animate-bounce' : ''}>
        ...
        {skin === 'farcaster' && (
          <>
            ...
            <ellipse cx="20" cy="30" rx="14" ry="18" fill="none" stroke="#8465CB" strokeWidth="1.5" opacity="0.3" className="animate-pulse" />
            {/* Full purple hoodie body */}
            <rect x="11" y="22" width="18" height="22" rx="4" fill="#8465CB" />
            {/* Hoodie hood over head — wider */}
            <path d="M 9 18 Q 8 4, 20 2 Q 32 4, 31 18" fill="#8465CB" stroke="#5B47A8" strokeWidth="1.5" />
            {/* Hood inner shadow */}
            <path d="M 12 18 Q 11 7, 20 5 Q 29 7, 28 18" fill="#5B47A8" opacity="0.5" />
            {/* FARCASTER ARCH (logo shape) on chest */}
            {/* Outer rectangle */}
            <rect x="14" y="25" width="12" height="10" rx="1" fill="#5B47A8" />
            {/* Arch cutout shape — the iconic Farcaster arch */}
            <path d="M 15 34 L 15 27 L 26 27 L 26 34 L 24 34 L 24 29.5 Q 20 26.5, 16 29.5 L 16 34 Z" fill="#8465CB" />
            {/* Inner arch dome */}
            <path d="M 16.5 29.5 Q 20 27.5, 23.5 29.5" fill="none" stroke="white" strokeWidth="1" />
            {/* Sleeve lines */}
            <line x1="11" y1="26" x2="11" y2="34" stroke="#5B47A8" strokeWidth="2" strokeLinecap="round" />
            <line x1="29" y1="26" x2="29" y2="34" stroke="#5B47A8" strokeWidth="2" strokeLinecap="round" />
            {/* Small sparkles */}
            <text x="6" y="11" fontSize="4" fill="#E8E0F7" opacity="0.9">✦</text>
            <text x="29" y="11" fontSize="4" fill="#E8E0F7" opacity="0.9">✦</text>
          </>
        )}
