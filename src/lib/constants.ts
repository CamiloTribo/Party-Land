 ...
 */
export const APP_URL: string = process.env.NEXT_PUBLIC_URL || 'https://party-land.vercel.app';
export const FARCASTER_MINIAPP_URL = 'https://farcaster.xyz/miniapps/1bhqOrw3ONX6/party-land';
 ...
 */
export const APP_ICON_URL: string = `${APP_URL}/app-store-icon.png`;

/**
 * URL for the app's Open Graph image.
 * Used for social media sharing and previews.
 */
export const APP_OG_IMAGE_URL: string = `${APP_URL}/hero-image.jpg`;
...
/**
 * Screenshots of the app for the Farcaster mini app store.
 */
export const APP_SCREENSHOT_URLS: string[] = [
  `${APP_URL}/screenshot-1.jpg`,
  `${APP_URL}/screenshot-2.jpg`,
  `${APP_URL}/screenshot-3.jpg`,
];
...
/**
 * Central treasury wallet address.
 * This is the wallet that receives USDC payments from users
 * AND sends out USDC milestone rewards.
 * Loaded from env to avoid exposing it in source code.
 */
export const PAYMENT_WALLET_ADDRESS: `0x${string}` = (
  process.env.NEXT_PUBLIC_CENTRAL_WALLET_ADDRESS || '0x27093F850B8E60E6f52610CBdD824D21ac29fbCB'
) as `0x${string}`;
...
/**
 * USDC contract address on Base (Circle's native USDC).
 * Verified: 0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913
 */
export const USDC_ADDRESS: `0x${string}` = '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913';

/**
 * Base Builder Code for onchain attribution.
 * Used to attribute transactions to Party Land on Base leaderboards.
 */
export const BUILDER_CODE = process.env.NEXT_PUBLIC_BUILDER_CODE || 'bc_gxwyq1ir';
